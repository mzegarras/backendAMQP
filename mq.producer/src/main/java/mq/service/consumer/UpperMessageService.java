...
public class UpperMessageService implements javax.jms.MessageListener {
	...
	public void onMessage(Message msg) {
		...
		if(msg instanceof TextMessage) {
			System.out.println(UpperMessageService.class.getCanonicalName());
			...
			try {
				...
				System.out.println(UpperMessageService.class.getCanonicalName() + "error");
				System.err.println(e);
			}
			
			
			System.out.println(UpperMessageService.class.getCanonicalName() + "end");
		}else{
			System.out.println(UpperMessageService.class.getCanonicalName() + "null");
		}
	}
